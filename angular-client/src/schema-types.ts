...
export interface Mutation {
    ...
    vote(// The full repository name from GitHub, e.g. "apollostack/GitHunt-API"
        repoFullName: string,
        // The export interface of vote - UP, DOWN, or CANCEL
        type: VoteType): Entry;

    // Comment on a repository, returns the new comment
    submitComment(// The full repository name from GitHub, e.g. "apollostack/GitHunt-API"
        repoFullName: string,
...
export interface Query {
    ...
    feed(// The sort order for the feed
        type: FeedType,
    ...
    // A single entry
    entry(// The full repository name from GitHub, e.g. "apollostack/GitHunt-API"
